    ...
    if clickData is None:
        return html.Div([
            ...
            html.Ul([
                ...
                html.Li("To learn more about the measure, its formulaic variables (if quantitative), secondary harm (if present), and relative context of use, please click the link on each measurement process to access the authors’ publication.")
            ]),
